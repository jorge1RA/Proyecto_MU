 ...
 * nosotros.php
 * 
 * Página "Sobre Nosotros" de ModaUrbana.
 * Proporciona información sobre la misión, la historia y los objetivos de la tienda de moda.
 * La página describe el enfoque innovador de reutilización de prendas de vestir para promover una moda sostenible.
 * 
...
<div class="container mt-4">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <!-- 
            Información sobre la historia, filosofía y objetivos de ModaUrbana. 
            -->
        ...
        <div class="col-md-6">
            ...
            <!-- 
            Imagen ilustrativa de ModaUrbana. 
            -->
            <img src="/modaurbana/assets/img/sucursal.jpg" alt="Equipo de ModaUrbana" class="img-fluid rounded">
        </div>
    </div>
